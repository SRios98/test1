...
public class usuarioController {
    ...
    private void accionRegistrarUsuario(){
		...
		if (nombreU.isBlank() || contraseñaU.isBlank()) {
            showError("Accion Invalida", "Complete todos los datos.");
            return;
        }
        ...
        if (usuarioValido) {
            clearFields();
            showAlert("Completo", "Inicio Sesion satisfactoriamente");
            openCarroForm();
        } else {
            showError("Datos Incorrectos", "Ingrese los datos de inicio de sesión correctamente.");
            clearFields();
        }
